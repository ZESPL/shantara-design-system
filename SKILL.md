...
5. **Pricing lives on dedicated tariff surfaces only.** No rupee, dollar, or “from …” amounts, no indicative totals, no per-night figures, and no rate-validity dates on home, programme, enquiry, journal, app, component demos or type specimens. Link to the tariff card (`ui_kits/website/screens/TariffScreen.js`, brand-deck tariff slides, handbook tariff section). Never quote it elsewhere — rates become unmanageable the moment they are copied.

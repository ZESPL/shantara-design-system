Solid Himalaya with the rosette band on one edge, a Gold eyebrow and a Merino Light statement — the page's one accent (deck slide 3).
...
**Content.** The eyebrow turns Gold and the text Merino automatically (`data-ground="himalaya"`). A `PlainList` is fine; buttons are not — this is a statement, not a call to action.

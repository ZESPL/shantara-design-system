...
function RelatedArticles({
  ...
  return /*#__PURE__*/React.createElement(TileGrid, _extends({
    ...
    layout: layout,
    style: style
  }, rest), shown.map(a => /*#__PURE__*/React.createElement(Tile, {
    key: a.href || a.title,
    src: a.src,
    alt: a.alt || "",
    ratio: a.ratio || "3:2",
